...
namespace Galaxy.Angular.API.Infrastructure.Data.Repository
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        {
            Customer customerUpdate = _galaxyAngularContext.Customers.Where(w => w.CustomerId == customer.CustomerId).FirstOrDefault();
            ...
            customerUpdate.Latitude = customer.Latitude;
            customerUpdate.Longitude = customer.Longitude;
            customerUpdate.StateId = customer.StateId;
            _galaxyAngularContext.Customers.Update(customerUpdate);
